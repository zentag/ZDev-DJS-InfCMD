...
module.exports = {
    ...
    callback: ({ message, prefix, args }) => {
        ...
        for (const command of commands) {
            ...
            if (permissions) {
                ...
                for (const permission of permissions) {
                    if(message.memeber == null) continue
            ...
            if((args[0] == undefined || args[0] == 1) && page == 1){
            ...
            else if((args[0] !== undefined && args[0] == 2) && page == 2){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 3) && page == 3){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 4) && page == 4){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 5) && page == 5){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 6) && page == 6){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 7) && page == 7){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 8) && page == 8){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 9) && page == 9){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
            ...
            else if((args[0] !== undefined && args[0] == 10) && page == 10){
                if(description) cmddescription = `Description: ${description}`
                const save = aliases[0]
                aliases.shift()
                if(aliases.length > 0) cmddescription += `\nAliases: ${aliases.join(", ")}`
        ...
        // set footer
        if(args[0] == undefined) embed.setFooter(`Page 1/${page} | ${prefix}help <page>`)
